...
//		cout << errmsg << endl;
//	}
//	catch (...) // 捕获任意没有匹配的类型的异常，防止程序异常终止。但是这样捕获的不知道发生了什么错误
//	{
//		cout << "未知异常" << endl;
//	}
//
...
//int main()
//{
//	//xianyang::test_auto_ptr2();
//	//xianyang::test_unique_ptr();
//	//xianyang::test_shared_ptr();
//	//xianyang::test_shared_ptr_threads();
//	//xianyang::test_cycle_ref();
//
//	// 定制删除器 ->仿函数 lambda 
